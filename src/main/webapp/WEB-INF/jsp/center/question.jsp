...
<html lang="en"><head>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/resource/js/center/question.js"></script>
...
<body class=" theme-blue">
    ...
    <ul>
    <li><a href="#" data-target=".dashboard-menu" class="nav-header collapsed" data-toggle="collapse"><i class="fa fa-fw fa-dashboard"></i>资讯管理<i class="fa fa-collapse"></i></a></li>
    ...
    <li><a href="#" data-target=".premium-menu" class="nav-header " data-toggle="collapse"><i class="fa fa-fw fa-fighter-jet"></i>用户管理<i class="fa fa-collapse"></i></a></li>
        ...
        <li><ul class="accounts-menu nav nav-list collapse in">
            <li ><a href="questionIndex" id="116"><span class="fa fa-caret-right"></span>问题列表</a></li>
...
<div class="main-content">
		...
		<input type="text" id="userKeyWord" class="span2">
